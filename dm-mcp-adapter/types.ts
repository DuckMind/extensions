...
import type { TextContent, ImageContent } from "@duckmind/dm-ai";
...
export const MCP_STATUS_EVENT = "dm-mcp-adapter/status/v1";
...
export const MCP_TOOL_APPROVAL_REQUEST_EVENT = "dm-mcp-adapter:tool-approval-request" as const;
