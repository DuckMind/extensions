...
<body>
  ...
  <div class="overlay" id="completion-overlay">
    <div class="panel">
      <h2>Done</h2>
      <p>MCP UI session finished. You can close this page and return to DM.</p>
    </div>
  </div>
  <script type="module">
    ...
    const STREAM_CONTEXT_KEY = "dm-mcp-adapter/stream";
    const STREAM_PATCH_METHOD = "notifications/dm-mcp-adapter/ui-result-patch";
