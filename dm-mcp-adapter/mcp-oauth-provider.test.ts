...
describe("McpOAuthProvider", () => {
  ...
  describe("clientMetadata", () => {
    ...
    it("should return correct metadata for public client", () => {
      ...
      assert.strictEqual(metadata.client_name, "DM Coding Agent")
      assert.strictEqual(metadata.client_uri, "https://github.com/nicobailon/dm-mcp-adapter")
    ...
    it("should keep the historical client name on stock pi", () => {
      ...
      delete process.env.PI_PACKAGE_DIR
      try {
        assert.strictEqual(createProvider().clientMetadata.client_name, "DM Coding Agent")
      } finally {
