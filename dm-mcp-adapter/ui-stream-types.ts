...
export const UI_STREAM_HOST_CONTEXT_KEY = "dm-mcp-adapter/stream";
export const UI_STREAM_REQUEST_META_KEY = "dm-mcp-adapter/stream-token";
export const UI_STREAM_RESULT_PATCH_METHOD = "notifications/dm-mcp-adapter/ui-result-patch";
export const SERVER_STREAM_RESULT_PATCH_METHOD = "notifications/dm-mcp-adapter/result-patch";
export const UI_STREAM_STRUCTURED_CONTENT_KEY = "dm-mcp-adapter/stream";
