...
import type { ExtensionMode, ExtensionUIContext } from "@duckmind/dm-coding-agent";
...
describe("elicitation with the real MCP SDK", () => {
  ...
  it.each([
    ["tui", { form: {}, url: {} }],
    ["rpc", { form: {} }],
  ] as const)("advertises stock DM %s capabilities and completes form elicitation", async (mode, capabilities) => {
  ...
  it("rejects URL elicitation over real SDK dispatch in stock DM RPC mode", async () => {
