import type { AgentToolResult, ToolRenderResultOptions } from "@duckmind/dm-coding-agent";
...
describe("MCP tool result renderer", () => {
  ...
  it("renders adapter error details expanded even when DM context is not marked as an error", () => {
    const output = renderMcpToolResult(
