...
const STORE_ENV = "DM_MCP_ADAPTER_TEST_AUTH_STORE";
const DISABLE_ENV = "DM_MCP_ADAPTER_DISABLE_AUTH_CACHE";
const RECOVERY_OVERRIDE_ENV = "DM_MCP_ADAPTER_TEST_LINUX_KEYRING_RECOVERY";
const DISABLE_KEYRING_RECOVERY_ENV = "DM_MCP_ADAPTER_DISABLE_KEYRING_RECOVERY";
