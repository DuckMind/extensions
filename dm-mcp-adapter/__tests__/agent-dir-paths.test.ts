...
describe("DM agent dir paths", () => {
  ...
  it("uses PI_CODING_AGENT_DIR for DM-owned config and state files", async () => {
    ...
    expect(existsSync(join(home, ".dm", "agent", "mcp-oauth", "demo", "tokens.json"))).toBe(false);
  });
