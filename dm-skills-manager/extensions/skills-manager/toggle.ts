...
import { getAgentDir, SettingsManager, type PackageSource } from "@duckmind/dm-coding-agent";
import { findProjectDmDir, projectSettingsTrusted } from "./paths.js";
...
function getTopLevelPattern(skill: SkillEntry, cwd: string): string {
	const baseDir = skill.scope === "project" ? findProjectDmDir(cwd) : getAgentDir();
