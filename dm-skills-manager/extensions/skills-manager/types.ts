import type { ThinkingLevel } from "@duckmind/dm-ai";
...
export const LOCATION_OPTIONS: CreateChoiceOption[] = [
	{ value: "project", label: "Project", description: "Save in this project's .dm/skills directory." },
	{ value: "global", label: "Global", description: "Save in your user-level DM skills directory." },
];
...
export const CREATE_STEPS: CreateStep[] = [
	...
	{ id: "location", title: "Visibility", hint: "Choose whether the skill is project-local or available in all DM sessions.", optional: false, kind: "choice", options: LOCATION_OPTIONS },
];
