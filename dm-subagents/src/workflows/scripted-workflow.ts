...
export async function runWorkflowScript(options: RunWorkflowScriptOptions): Promise<WorkflowScriptResult> {
	...
	try {
		...
		throw new Error("Workflow parser dependency 'acorn' is unavailable from dm-subagents. Reinstall dm-subagents dependencies before launching workflowScript.", { cause: error });
	}
