import { DynamicBorder, keyHint, rawKeyHint, type Theme } from "@duckmind/dm-coding-agent";
import { Container, fuzzyFilter, Input, type KeybindingsManager, Spacer, Text, type TUI } from "@duckmind/dm-tui";
 ...
 * out of view when the option list is long. Composed from dm's own TUI primitives so it
