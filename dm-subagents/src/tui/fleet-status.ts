...
import { type EditorComponent, isKeyRelease, Key, matchesKey, truncateToWidth, visibleWidth } from "@duckmind/dm-tui";
...
export class SubagentFleetStatus {
	...
	private editorHasFocus(): boolean {
		// dm-tui exposes focus mutation but no focus getter, so inspect the focused
