...
export const PROJECT_SUBAGENTS_RELATIVE_DIR = ".dm/subagents";
...
export function getProjectArtifactPackagingWarning(cwd: string): string | undefined {
	...
	return "Project-scoped subagent artifacts can be included when this package is published. Add '.dm/subagents/' to .npmignore, restrict package.json files, or set artifactDir to 'session' or 'temp'.";
}
