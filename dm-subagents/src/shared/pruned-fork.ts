...
import type { TextContent } from "@duckmind/dm-ai";
import { completeSimple } from "@duckmind/dm-ai/compat";
...
const SYSTEM_PROMPT = `You summarize overflow items from a forked DM coding-agent transcript.
