...
const UNSUPPORTED = {
	...
	toolEvents: "The generic external CLI adapter treats stdout as untrusted text, not native DM tool events.",
	supervisor: "The generic external CLI adapter has no trusted supervisor event transport.",
	forkContext: "Native DM fork context is not available without an adapter-owned handoff artifact.",
	extensionBindings: "Native DM extension bindings are never passed to external runners.",
} as const;
