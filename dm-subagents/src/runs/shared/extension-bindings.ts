export const DM_SUBAGENT_EXTENSION_BINDINGS_ENV = "DM_SUBAGENT_EXTENSION_BINDINGS";
...
export function omitExtensionBindingsEnv(env: NodeJS.ProcessEnv): NodeJS.ProcessEnv {
	const { [DM_SUBAGENT_EXTENSION_BINDINGS_ENV]: _extensionBindings, ...sanitized } = env;
	return sanitized;
}
