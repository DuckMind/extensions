...
// or the tool is inactive in context. Match dm-cursor-sdk display labels.
...
function hasCheckpointMutationEvidence(message: Message): boolean {
	...
	if ((record.role !== "custom" && record.type !== "custom") || record.customType !== "dm-checkpoint") return false;
