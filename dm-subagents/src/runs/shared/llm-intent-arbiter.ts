...
import { Agent, type AgentTool, type StreamFn } from "@duckmind/dm-agent-core";
import { convertToLlm, type ExtensionContext } from "@duckmind/dm-coding-agent";
import { streamSimple } from "@duckmind/dm-ai/compat";
import type { ProviderHeaders } from "@duckmind/dm-ai";
 ...
 *
 * Enabled by default; set DM_SUBAGENTS_LLM_INTENT_ARBITER=0 to disable.
 */
...
export function createTaskMutationArbiter(
	...
	if (process.env.DM_SUBAGENTS_LLM_INTENT_ARBITER === "0") return undefined;
