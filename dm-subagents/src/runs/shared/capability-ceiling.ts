...
export const SUBAGENT_CAPABILITY_CEILING_REGISTRY_KEY = "dm-subagents.capability-ceiling.v1";
export const SUBAGENT_CAPABILITY_CEILING_ENV = "DM_SUBAGENT_CAPABILITY_CEILING_V1";
