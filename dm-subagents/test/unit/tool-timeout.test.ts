...
describe("toolTimeoutFromEnv", () => {
	it("reads DM_SUBAGENT_TOOL_TIMEOUT_MS from the process env", () => {
		assert.equal(TOOL_TIMEOUT_ENV, "DM_SUBAGENT_TOOL_TIMEOUT_MS");
		assert.equal(toolTimeoutFromEnv({ DM_SUBAGENT_TOOL_TIMEOUT_MS: "123" }), "123");
