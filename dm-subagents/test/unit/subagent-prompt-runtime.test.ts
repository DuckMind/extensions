...
} from "../../src/runs/shared/dm-args.ts";
...
const envSnapshot = {
	DM_SUBAGENT_INHERIT_PROJECT_CONTEXT: process.env.DM_SUBAGENT_INHERIT_PROJECT_CONTEXT,
	DM_SUBAGENT_INHERIT_GLOBAL_CONTEXT: process.env.DM_SUBAGENT_INHERIT_GLOBAL_CONTEXT,
	DM_SUBAGENT_INHERIT_SKILLS: process.env.DM_SUBAGENT_INHERIT_SKILLS,
	DM_SUBAGENT_INTERCOM_SESSION_NAME: process.env.DM_SUBAGENT_INTERCOM_SESSION_NAME,
	DM_SUBAGENT_FANOUT_CHILD: process.env.DM_SUBAGENT_FANOUT_CHILD,
	DM_SUBAGENT_STEER_INBOX: process.env.DM_SUBAGENT_STEER_INBOX,
	DM_SUBAGENT_STEER_CAPABILITY: process.env.DM_SUBAGENT_STEER_CAPABILITY,
	DM_SUBAGENT_STEER_ACK_DIR: process.env.DM_SUBAGENT_STEER_ACK_DIR,
	DM_SUBAGENT_STRUCTURED_OUTPUT_CAPTURE: process.env.DM_SUBAGENT_STRUCTURED_OUTPUT_CAPTURE,
	DM_SUBAGENT_STRUCTURED_OUTPUT_SCHEMA: process.env.DM_SUBAGENT_STRUCTURED_OUTPUT_SCHEMA,
	DM_SUBAGENT_RUNTIME_ACKNOWLEDGED_EXTENSIONS: process.env.DM_SUBAGENT_RUNTIME_ACKNOWLEDGED_EXTENSIONS,
	DM_SUBAGENT_TOOL_BUDGET: process.env.DM_SUBAGENT_TOOL_BUDGET,
	DM_SUBAGENT_PERMISSION_POLICY: process.env.DM_SUBAGENT_PERMISSION_POLICY,
	DM_SUBAGENT_REQUIRED_TOOLS: process.env.DM_SUBAGENT_REQUIRED_TOOLS,
	DM_SUBAGENT_MCP_DIRECT_TOOLS: process.env.DM_SUBAGENT_MCP_DIRECT_TOOLS,
	DM_SUBAGENT_TOOL_DIAGNOSTIC_PATH: process.env.DM_SUBAGENT_TOOL_DIAGNOSTIC_PATH,
	DM_SUBAGENT_ORCHESTRATOR_TARGET: process.env.DM_SUBAGENT_ORCHESTRATOR_TARGET,
	DM_SUBAGENT_ORCHESTRATOR_SESSION_ID: process.env.DM_SUBAGENT_ORCHESTRATOR_SESSION_ID,
	DM_SUBAGENT_SUPERVISOR_CHANNEL_DIR: process.env.DM_SUBAGENT_SUPERVISOR_CHANNEL_DIR,
	DM_SUBAGENT_RUN_ID: process.env.DM_SUBAGENT_RUN_ID,
	DM_SUBAGENT_CHILD_AGENT: process.env.DM_SUBAGENT_CHILD_AGENT,
	DM_SUBAGENT_CHILD_INDEX: process.env.DM_SUBAGENT_CHILD_INDEX,
	DM_SUBAGENT_WATCHDOG_CHILD_CONFIG: process.env.DM_SUBAGENT_WATCHDOG_CHILD_CONFIG,
};

const SKILLS_SECTION = "\n\nThe following skills provide specialized instructions for specific tasks.\nUse the read tool to load a skill's file when the task matches its description.\nWhen a skill file references a relative path, resolve it against the skill directory (parent of SKILL.md / dirname of the path) and use that absolute path in tool commands.\n\n<available_skills>\n  <skill>\n    <name>safe-bash</name>\n    <description>desc</description>\n    <location>/tmp/SKILL.md</location>\n  </skill>\n  <skill>\n    <name>dm-subagents</name>\n    <description>delegate to subagents</description>\n    <location>/tmp/dm-subagents/SKILL.md</location>\n  </skill>\n</available_skills>";
...
afterEach(() => {
	if (envSnapshot.DM_SUBAGENT_INHERIT_PROJECT_CONTEXT === undefined) delete process.env.DM_SUBAGENT_INHERIT_PROJECT_CONTEXT;
	else process.env.DM_SUBAGENT_INHERIT_PROJECT_CONTEXT = envSnapshot.DM_SUBAGENT_INHERIT_PROJECT_CONTEXT;
	if (envSnapshot.DM_SUBAGENT_INHERIT_GLOBAL_CONTEXT === undefined) delete process.env.DM_SUBAGENT_INHERIT_GLOBAL_CONTEXT;
	else process.env.DM_SUBAGENT_INHERIT_GLOBAL_CONTEXT = envSnapshot.DM_SUBAGENT_INHERIT_GLOBAL_CONTEXT;
	if (envSnapshot.DM_SUBAGENT_INHERIT_SKILLS === undefined) delete process.env.DM_SUBAGENT_INHERIT_SKILLS;
	else process.env.DM_SUBAGENT_INHERIT_SKILLS = envSnapshot.DM_SUBAGENT_INHERIT_SKILLS;
	if (envSnapshot.DM_SUBAGENT_INTERCOM_SESSION_NAME === undefined) delete process.env.DM_SUBAGENT_INTERCOM_SESSION_NAME;
	else process.env.DM_SUBAGENT_INTERCOM_SESSION_NAME = envSnapshot.DM_SUBAGENT_INTERCOM_SESSION_NAME;
	if (envSnapshot.DM_SUBAGENT_FANOUT_CHILD === undefined) delete process.env.DM_SUBAGENT_FANOUT_CHILD;
	else process.env.DM_SUBAGENT_FANOUT_CHILD = envSnapshot.DM_SUBAGENT_FANOUT_CHILD;
	if (envSnapshot.DM_SUBAGENT_STEER_INBOX === undefined) delete process.env[SUBAGENT_STEER_INBOX_ENV];
	else process.env[SUBAGENT_STEER_INBOX_ENV] = envSnapshot.DM_SUBAGENT_STEER_INBOX;
	if (envSnapshot.DM_SUBAGENT_STEER_CAPABILITY === undefined) delete process.env[SUBAGENT_STEER_CAPABILITY_ENV];
	else process.env[SUBAGENT_STEER_CAPABILITY_ENV] = envSnapshot.DM_SUBAGENT_STEER_CAPABILITY;
	if (envSnapshot.DM_SUBAGENT_STEER_ACK_DIR === undefined) delete process.env[SUBAGENT_STEER_ACK_DIR_ENV];
	else process.env[SUBAGENT_STEER_ACK_DIR_ENV] = envSnapshot.DM_SUBAGENT_STEER_ACK_DIR;
	if (envSnapshot.DM_SUBAGENT_STRUCTURED_OUTPUT_CAPTURE === undefined) delete process.env[STRUCTURED_OUTPUT_CAPTURE_ENV];
	else process.env[STRUCTURED_OUTPUT_CAPTURE_ENV] = envSnapshot.DM_SUBAGENT_STRUCTURED_OUTPUT_CAPTURE;
	if (envSnapshot.DM_SUBAGENT_STRUCTURED_OUTPUT_SCHEMA === undefined) delete process.env[STRUCTURED_OUTPUT_SCHEMA_ENV];
	else process.env[STRUCTURED_OUTPUT_SCHEMA_ENV] = envSnapshot.DM_SUBAGENT_STRUCTURED_OUTPUT_SCHEMA;
	if (envSnapshot.DM_SUBAGENT_RUNTIME_ACKNOWLEDGED_EXTENSIONS === undefined) delete process.env[RUNTIME_EXTENSION_ACK_PATH_ENV];
	else process.env[RUNTIME_EXTENSION_ACK_PATH_ENV] = envSnapshot.DM_SUBAGENT_RUNTIME_ACKNOWLEDGED_EXTENSIONS;
	if (envSnapshot.DM_SUBAGENT_TOOL_BUDGET === undefined) delete process.env[TOOL_BUDGET_ENV];
	else process.env[TOOL_BUDGET_ENV] = envSnapshot.DM_SUBAGENT_TOOL_BUDGET;
	if (envSnapshot.DM_SUBAGENT_PERMISSION_POLICY === undefined) delete process.env[PERMISSION_POLICY_ENV];
	else process.env[PERMISSION_POLICY_ENV] = envSnapshot.DM_SUBAGENT_PERMISSION_POLICY;
	if (envSnapshot.DM_SUBAGENT_REQUIRED_TOOLS === undefined) delete process.env[REQUIRED_CHILD_TOOLS_ENV];
	else process.env[REQUIRED_CHILD_TOOLS_ENV] = envSnapshot.DM_SUBAGENT_REQUIRED_TOOLS;
	if (envSnapshot.DM_SUBAGENT_MCP_DIRECT_TOOLS === undefined) delete process.env[MCP_DIRECT_CHILD_TOOLS_ENV];
	else process.env[MCP_DIRECT_CHILD_TOOLS_ENV] = envSnapshot.DM_SUBAGENT_MCP_DIRECT_TOOLS;
	if (envSnapshot.DM_SUBAGENT_TOOL_DIAGNOSTIC_PATH === undefined) delete process.env[CHILD_TOOL_DIAGNOSTIC_PATH_ENV];
	else process.env[CHILD_TOOL_DIAGNOSTIC_PATH_ENV] = envSnapshot.DM_SUBAGENT_TOOL_DIAGNOSTIC_PATH;
	if (envSnapshot.DM_SUBAGENT_ORCHESTRATOR_TARGET === undefined) delete process.env[SUBAGENT_ORCHESTRATOR_TARGET_ENV];
	else process.env[SUBAGENT_ORCHESTRATOR_TARGET_ENV] = envSnapshot.DM_SUBAGENT_ORCHESTRATOR_TARGET;
	if (envSnapshot.DM_SUBAGENT_ORCHESTRATOR_SESSION_ID === undefined) delete process.env[SUBAGENT_ORCHESTRATOR_SESSION_ID_ENV];
	else process.env[SUBAGENT_ORCHESTRATOR_SESSION_ID_ENV] = envSnapshot.DM_SUBAGENT_ORCHESTRATOR_SESSION_ID;
	if (envSnapshot.DM_SUBAGENT_SUPERVISOR_CHANNEL_DIR === undefined) delete process.env[SUBAGENT_SUPERVISOR_CHANNEL_DIR_ENV];
	else process.env[SUBAGENT_SUPERVISOR_CHANNEL_DIR_ENV] = envSnapshot.DM_SUBAGENT_SUPERVISOR_CHANNEL_DIR;
	if (envSnapshot.DM_SUBAGENT_RUN_ID === undefined) delete process.env[SUBAGENT_RUN_ID_ENV];
	else process.env[SUBAGENT_RUN_ID_ENV] = envSnapshot.DM_SUBAGENT_RUN_ID;
	if (envSnapshot.DM_SUBAGENT_CHILD_AGENT === undefined) delete process.env[SUBAGENT_CHILD_AGENT_ENV];
	else process.env[SUBAGENT_CHILD_AGENT_ENV] = envSnapshot.DM_SUBAGENT_CHILD_AGENT;
	if (envSnapshot.DM_SUBAGENT_CHILD_INDEX === undefined) delete process.env[SUBAGENT_CHILD_INDEX_ENV];
	else process.env[SUBAGENT_CHILD_INDEX_ENV] = envSnapshot.DM_SUBAGENT_CHILD_INDEX;
	if (envSnapshot.DM_SUBAGENT_WATCHDOG_CHILD_CONFIG === undefined) delete process.env[CHILD_WATCHDOG_CONFIG_ENV];
	else process.env[CHILD_WATCHDOG_CONFIG_ENV] = envSnapshot.DM_SUBAGENT_WATCHDOG_CHILD_CONFIG;
});
...
describe("subagent prompt runtime", () => {
	it("registers no permission hook by default and routes ask only to the watchdog arbiter", async () => {
		...
		const dm = { on(event: string, handler: (event: { toolName?: string; input?: unknown }, ctx?: unknown) => unknown) { if (event === "tool_call") handlers.push(handler); } };
		delete process.env[PERMISSION_POLICY_ENV];
		registerPermissionGate(dm as never);
		...
		assert.deepEqual(await handlers[0]!({ toolName: "write", input: {} }), {
			block: true,
			reason: "Blocked by dm-subagents permission rule: 'write' is denied.",
		});
	...
	it("fails closed when an ask permission decision stalls", async () => {
		try {
			...
			assert.deepEqual(result, {
				block: true,
				reason: "Blocked by dm-subagents permission rule: Watchdog permission arbiter failed closed: Watchdog permission decision timed out after 5ms.",
			});
		} finally {
			if (envSnapshot.DM_SUBAGENT_PERMISSION_POLICY === undefined) delete process.env[PERMISSION_POLICY_ENV];
			else process.env[PERMISSION_POLICY_ENV] = envSnapshot.DM_SUBAGENT_PERMISSION_POLICY;
	...
	it("does not acknowledge sendUserMessage until the correlated DM input event arrives", () => {
		...
		try {
			...
			assert.equal(acks[0]?.message, "DM accepted the correlated steering input.");
			handlers.get("session_shutdown")?.({});
		} finally {
			fs.rmSync(dir, { recursive: true, force: true });
		}
	...
	it("fails pending correlation when the session shuts down", () => {
		...
		try {
			...
			assert.match(ack?.message ?? "", /before DM confirmed steering input delivery/);
		} finally {
			fs.rmSync(dir, { recursive: true, force: true });
		}
	});
	...
	it("registers child watchdog lifecycle handlers only when enabled by env", () => {
		...
		// dm-subagents child, the runner sets it and an extra agent_end handler registers.
	...
	it("recognizes DM context filenames case-insensitively", () => {
		const globalDir = getAgentDir();
		const prompt = [
			"You are a subagent.",
			"\n\n<project_context>\n\nProject-specific instructions and guidelines:\n\n",
	...
	it("strips the subagent orchestration skill even when inherited skills remain", () => {
		...
		assert.ok(rewritten.includes("<name>safe-bash</name>"));
		assert.ok(!rewritten.includes("<name>dm-subagents</name>"));
		assert.ok(!rewritten.includes("delegate to subagents"));
	});

	it("strips explicit dm-subagents skill injection from child prompts", () => {
		const prompt = "Before\n\n<skill name=\"dm-subagents\">\nDo not keep this.\n</skill>\n\n<skill name=\"safe-bash\">\nKeep this.\n</skill>\nAfter";
	...
	it("defers native supervisor registration until runtime events and respects installed dm-intercom tools", async () => {
		setSupervisorEnv();
		const handlers = new Map<string, (payload?: unknown) => unknown>();
	...
	it("keeps installed dm-intercom while filling only a missing child contact_supervisor tool", async () => {
		setSupervisorEnv();
		const handlers = new Map<string, (payload?: unknown) => unknown>();
		const registered: string[] = [];
	...
	it("registers only native supervisor tools at runtime when dm-intercom is absent", async () => {
		setSupervisorEnv();
	...
	it("classifies missing resolved MCP direct tools without softening strict diagnostics", () => {
		...
		try {
			...
			assert.match(formatChildToolDiagnostic(diagnostic!), /host\/dm-mcp-adapter registration problem/);
	...
	it("rewrites the final child-visible prompt through before_agent_start", async () => {
		...
		process.env.DM_SUBAGENT_INHERIT_PROJECT_CONTEXT = "0";
		process.env.DM_SUBAGENT_INHERIT_SKILLS = "0";
	...
	it("uses the fanout boundary through before_agent_start when fanout env is set", async () => {
		...
		process.env.DM_SUBAGENT_INHERIT_PROJECT_CONTEXT = "1";
		process.env.DM_SUBAGENT_INHERIT_SKILLS = "1";
		process.env[SUBAGENT_FANOUT_CHILD_ENV] = "1";
