...
describe("model fallback helpers", () => {
	...
	it("skips unavailable fallback models and warns once for each", () => {
		...
		assert.deepEqual(warnings, [
			"[dm-subagents] Skipping fallback model 'does-not-exist' because it is unavailable in this environment.",
			"[dm-subagents] Skipping fallback model 'also-unavailable' because it is unavailable in this environment.",
		]);
	});
