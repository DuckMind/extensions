 ...
 * settings.ts transitively depends on dm packages.
 */
...
describe("resolveChainTemplates", { skip: !available ? "dm packages not available" : undefined }, () => {
...
describe("isParallelStep", { skip: !available ? "dm packages not available" : undefined }, () => {
...
describe("normalizeSkillInput", { skip: !available ? "dm packages not available" : undefined }, () => {
...
describe("resolveStepBehavior", { skip: !available ? "dm packages not available" : undefined }, () => {
...
describe("resolveParallelBehaviors", { skip: !available ? "dm packages not available" : undefined }, () => {
...
describe("read-only progress suppression", { skip: !available ? "dm packages not available" : undefined }, () => {
...
describe("buildChainInstructions", { skip: !available ? "dm packages not available" : undefined }, () => {
...
describe("createChainDir", { skip: !available ? "dm packages not available" : undefined }, () => {
