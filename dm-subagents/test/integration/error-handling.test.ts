 ...
 *
 * Requires dm packages for execution tests. Skips gracefully if unavailable.
 */
...
describe("runSync error handling", { skip: !piAvailable ? "dm packages not available" : undefined }, () => {
	let tempDir: string;
	let mockPi: MockPi;
