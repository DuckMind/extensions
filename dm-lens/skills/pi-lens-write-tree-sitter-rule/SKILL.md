---
name: dm-lens-write-tree-sitter-rule
description: Use when writing a new dm-lens tree-sitter query rule YAML file — covers schema, S-expression syntax, capture names, predicates, and gotchas
---

# Writing a dm-lens tree-sitter Rule
...
✅ For rule-bug fixes, also add a real-runner regression test through
   ...
   (These test paths exist only in a dm-lens source checkout — the installed
