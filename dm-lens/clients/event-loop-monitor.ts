 ...
 *
 * dm-lens runs on pi's TUI event loop; a long synchronous block freezes
 ...
 * process was paging, not sleeping. Both are machine artifacts, not dm-lens
 ...
 * plausible synchronous dm-lens stall (`floorMs`, default 20 s — the real tier
 ...
 * dm-lens block that is BLOCKED IN A SYSCALL for >20 s — e.g. a `readdirSync` /
