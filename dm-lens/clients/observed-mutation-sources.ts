/**
 * What dm-lens ALREADY tracks, and where an observed change is replayed to
 * (#2430).
 *
 ...
 * dm-lens has already seen; a walk would make the settle boundary pay for the
...
/**
 * Files dm-lens has read, written, diagnosed, or opened on a language server.
 *
 ...
 * post-mutation re-hash names exactly the lines that changed without dm-lens
 ...
 *
 * Returns `false` when the bridge is not mounted (dm-lens not activated, or a
