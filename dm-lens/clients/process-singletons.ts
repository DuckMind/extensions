 ...
 *
 * WHY THIS MODULE EXISTS. pi evaluates the dm-lens module graph more than once
 ...
 * The record still reaches `dmlens_health`, with no import from here.
 */

/** Bump only when the CONTAINER shape changes, never for a family's shape. */
const SINGLETON_HOST_KEY = Symbol.for("dm-lens.process-singletons.v1");

const SINGLETON_SCHEMA = "dm-lens.process-singletons";
...
/**
 * How many times this process has evaluated the dm-lens module graph, 1-based.
 *
