/**
 * Post-write pipeline for dm-lens
 *
...
function lspSyncBudgetMs(): number {
	const raw = Number(process.env.DM_LENS_LSP_SYNC_BUDGET_MS);
...
export interface PipelineResult {
	...
	/** Files modified by dm-lens format/autofix, including side-effect files. */
	changedFiles?: string[];
