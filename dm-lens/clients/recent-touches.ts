 ...
 * autoformatted by dm-lens" context nudge, fed by the IN-PROCESS
 * `dmlens:files:touched` bus event (#482, clients/bus-publish.ts). That
 ...
 *     working in the same tree after the child returns and its dm-lens
 ...
 * `.dm-lens` path) that every dm-lens instance (parent or child) both
