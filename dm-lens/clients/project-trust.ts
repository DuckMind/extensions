 ...
 * *consumes* the outcome through `ExtensionContext.isProjectTrusted()`. dm-lens
 ...
 * (`@duckmind/dm-coding-agent/dist/core/extensions/types.d.ts`):
 ...
 * accessor collapses it to a boolean. So the only distinctions dm-lens can make
 ...
 * missing surface, because that would silently disable dm-lens on every older
 * host.
 */
