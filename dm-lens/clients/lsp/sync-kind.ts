 ...
 * dm-lens always sent a single whole-document `{ text }` change event — valid
 ...
 * `Full` when the server doesn't advertise one — the same shape dm-lens has
 ...
 * reply. Defaults to `Full` (dm-lens's historical always-whole-document
