 ...
 * document version the diagnostics apply to). dm-lens already owns the
 ...
 * the SAME raw `utf-8` transform dm-lens builds LSP payloads with) round-trips
 ...
 *
 * READ-TRANSFORM SYMMETRY (the CRLF/BOM invariant): dm-lens builds every LSP
