 ...
 * `globalThis[Symbol.for("dm-lens:...")]` key so a same-process producer can
 * reach dm-lens's bookkeeping without importing its internals. Both bridges
 ...
 * `globalThis[Symbol.for("dm-lens:mutation-bridge")]` directly as a frozen,
 ...
 * signal for dm-lens to silently reset its own mount. Reusing the singleton
