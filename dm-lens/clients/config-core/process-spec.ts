 ...
 *
 * `unknown` does not pass for repo tiers. Elsewhere in dm-lens `unknown` is
 ...
 * `isToolInstallAllowedByTrust` gates dm-lens's OWN managed tools, while this
 ...
 * their content did not arrive with the checkout, and dm-lens's separate
