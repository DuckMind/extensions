 ...
 * - `operator` — a deliberate act by the person running dm-lens: their global
 ...
 * - `default` — dm-lens's OWN shipped defaults. Nobody chose them.
 *
 ...
 * lifts an operator denial, a built-in `enabled: false` — or any member dm-lens
 ...
 * than re-spelled. dm-lens CONSUMES the host decision (AGENTS.md, "Project
...
/**
 * True for tiers the person running dm-lens set deliberately.
 *
