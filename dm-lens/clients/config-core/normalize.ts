 ...
 * 2. UNKNOWN FIELDS ARE DROPPED, NOT KEPT. dm-lens's default is closed, unlike
...
export interface ValidateOptions {
	 ...
	 * review round 3, F1) — `reportDmLensConfigRecords` needs it to route a
	 * dm-lens-owned record to the right subsystem.
	 */
