 ...
 * separate, explicit step — `reportDmLensConfigRecords` in
 ...
 * (`loadDmLensGlobalConfig`), and `clients/project-lens-config.ts`
 * (`loadDmLensProjectConfig`) are now projections of one resolution. #2416
