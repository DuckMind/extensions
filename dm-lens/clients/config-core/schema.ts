 ...
 * laziness: #2416 publishes the same object as `docs/schema/dm-lens-config-v1.json`
 ...
 *
 * Three dm-lens annotations extend the vocabulary, all `x-`-prefixed so a
 ...
 *
 * `"drop"` is dm-lens's DEFAULT, and it differs from JSON Schema's, where a
