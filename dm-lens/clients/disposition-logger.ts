 ...
 * clients/actionable-warnings-logger.ts: machine-global (getGlobalDmLensLogDir),
...
const DISPOSITION_LOG_DIR = getGlobalDmLensLogDir();
...
const MAX_LOG_BYTES = Math.max(
	128 * 1024,
	Number.parseInt(
		process.env.DM_LENS_DISPOSITION_LOG_MAX_BYTES ?? "1048576",
		10,
	) || 1048576,
);
