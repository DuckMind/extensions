 ...
 * `<cwd>/.dm-lens` only when that legacy directory already exists, otherwise
 * `~/.dm-lens/projects/<slug>` or a `PILENS_DATA_DIR` location. Never assume
