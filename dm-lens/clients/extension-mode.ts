 ...
 * pinned host types (`@duckmind/dm-coding-agent/dist/core/extensions/
 * types.d.ts`):
 *
 ...
 *
 * dm-lens previously derived terminal ownership from nothing at all — it
...
/**
 * Whether a terminal-only custom component (the dm-lens diagnostics widget) can
