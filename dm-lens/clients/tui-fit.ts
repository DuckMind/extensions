 ...
 * the turn-summary message renderer). dm-tui-compat's `TUI.doRender` HARD-CRASHES the
 ...
 * "@duckmind/dm-tui" specifier depending on which runtime resolves it:
 *   - pure-JS dm-tui-compat:        (text, maxWidth, ellipsis: string, pad?)
 ...
 * ("..."), Omit=2.
 */
import { truncateToWidth } from "./deps/dm-tui-compat.js";
