...
export class JscpdClient {
	// Absolute path of a MANAGED jscpd (the global ~/.dm-lens tools shim
	 ...
	 * That made dm-lens's jscpd integration effectively JS/TS-only even
	...
	private async runScan(
		...
		const outDir = mkdtempSync(`${os.tmpdir()}${path.sep}dm-lens-jscpd-`);
