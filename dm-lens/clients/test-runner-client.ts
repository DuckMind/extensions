/**
 * Test Runner Client for dm-lens
 *
...
export class TestRunnerClient {
	 ...
	 * more elapsed time than the run took. With the single suite dm-lens
	 ...
	 *
	 *   EXPECT THIS TO BE ABSENT IN PRACTICE. dm-lens invokes `mvn test -q`
	...
	private parseGenericRunnerOutput(
		...
		// is reachable without dm-lens passing the flag, because maven also
