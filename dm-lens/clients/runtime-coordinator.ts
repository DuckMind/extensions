...
export class RuntimeCoordinator {
	 ...
	 * an edit-shaped tool dm-lens does not name still demotes this file to the
	...
	formatPipelineCrashNotice(filePath: string, err: unknown): string {
		...
		return [
			"⚠️ dm-lens pipeline crashed while analyzing this write.",
	 ...
	 * `lsp_diagnostics` on F, dm-lens answered "confirmed clean", and the
 ...
 * (`@duckmind/dm-coding-agent/dist/core/extensions/runner.js:488-491`;
 * `dist/core/agent-session.js:580-582`). The value is a `Model` with `id` and
 * `provider` (`@duckmind/dm-ai/dist/types.d.ts:661-667`), or `undefined`
