 ...
 * index.ts` pins for dm-lens's managed ktfmt install. That CLI accepts
 ...
 *   manufactured a NEW dm-lens/Gradle disagreement (dm-lens writes
 *   `--google-style`, `./gradlew ktfmtCheck` then rejects the file dm-lens
 ...
 *   wrapper, or more than one nested block — reaches NEITHER scope. dm-lens
 ...
 * dm-lens cannot evaluate, and is NOT silently promoted to project-wide.
 */
