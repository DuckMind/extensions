 ...
 *     zero existing coverage in dm-lens, so no dedup needed.
 ...
 *     the only IaC-misconfig coverage dm-lens has for CFN.
 ...
 * `--severity` floor reuses `dm-lens.trivy.minSeverity` (default HIGH).
 *
 * Refs: #131 (Mode 2)
 */
