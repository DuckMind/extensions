/**
 * Project-level rule policy (`.dm-lens.json` `rules.<id>.disable` /
 ...
 * `DmLensProjectConfig.rules` already uses for `threshold`). The key is only
...
/**
 * Build the policy map from a `DmLensProjectConfig.rules`-shaped value. Returns
