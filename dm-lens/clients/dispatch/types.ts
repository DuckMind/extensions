/**
 * Redesigned Dispatch Types for dm-lens
 *
...
import type { DmLensProjectConfig } from "../project-lens-config.js";
...
export interface DispatchContext {
	...
	/** Project-local .dm-lens.json config captured for this dispatch. */
	readonly projectConfig?: DmLensProjectConfig;
