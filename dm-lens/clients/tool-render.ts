 ...
 * (`renderCall`) and the result row (`renderResult`). Most dm-lens tools
...
import type { Theme, ToolDefinition } from "@duckmind/dm-coding-agent";
 ...
 * `<name/hint> — <detail>` shape every dm-lens summarizer already produces
