...
describe("probeRequestCompat", () => {
  ...
  // unmapped is what makes DM omit the field and take the model's default.
...
describe("detectSglang", () => {
  ...
  // which SGLang applies when the request names none — and DM's don't. Qwen
...
describe("detectOpenAI", () => {
  ...
  // nothing; it exists so DM can tell a length-stopped reasoning response
...
describe("probeNinfer", () => {
  ...
  // Registering four times the real ceiling would let DM fill a context the
