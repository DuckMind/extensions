import { clampThinkingLevel, type ModelThinkingLevel, type ThinkingLevel } from "@duckmind/dm-ai";
import { complete, completeSimple, type Api, type Message, type Model } from "@duckmind/dm-ai/compat";
